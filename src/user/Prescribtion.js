...
import { Button, Text, IconButton, Fade, Backdrop, makeStyles } from '@material-ui/core';
...
import { getPatient } from './helper/patientapicalls';
// import './assets/css/dashres.css';

function Prescribtion({ handleClose, patientId }) {
